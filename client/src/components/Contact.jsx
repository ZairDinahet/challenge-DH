...
function Contact(props){
    console.log("isMobileMenuOpen:", props.isMobileMenuOpen);
                    ...
                    <p className="text-2xl text-stone-500">Formulario de contacto</p>
                        <span>
                            ...
                            <div className="w-full">
                                <label htmlFor="file-upload" className="mt-4 mb-4 p-2 relative cursor-pointer bg-stone-100 rounded-md border border-stone-500 font-medium text-stone-500 hover:text-teal-700 focus-within:outline-none focus-within:ring-2">
                                    <i className="bi bi-paperclip mr-1"></i>
                                    <span>Adjuntar archivo</span>
                                    <input id="file-upload" name="file-upload" type="file" className="sr-only"/>
                                </label>
                                <p id="file-upload-filename" className="mt-2 text-sm text-gray-500"></p>
                            </div>
                            {/** */}
