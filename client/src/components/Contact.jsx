        ...
        <div className="w-full xl:flex">
          <section className="m-0 p-7 xl:w-3/4 sm:w-full">
            <div className="p-4 mb-4 rounded-md border-2 bg-white border-stone-300">
              ...
              <p>
                <a href="#" target="_blank" className="link-external hover:text-teal-700">
            ...
            <div className="p-4 mt-4 rounded-md border-2 bg-white border-stone-300">
              <p className="text-2xl text-stone-500 py-4">Formulario de contacto</p>
              <span>
                <form action={url} method="POST" className="form_changes">
              ...
              <div className="p-4">
                ...
                <div className="">
                  <div className="">
                    <article className="text-center flex flex-col">
                      <p className="my-1">
                        <a href="#" target="_blank" className="hover:text-teal-700 font-bold">
                          Blog
                        </a>
                      </p>
                      <p className="my-1">
                ...
                <article className="text-center border-t-2 border-stone-300">
                  ...
                  <div className="footer__social-icons flex flex-row justify-around">
                    <a href="#" target="_blank" title="Míranos en YouTube" className="hover:text-yt">
                      <span className="bi bi-youtube"></span>
                    </a>
                    <a href="#" target="_blank" title="Síguenos en Instagram" className="hover:text-ig">
                      <span className="bi bi-instagram"></span>
                    </a>
                    <a href="#" target="_blank" title="Síguenos en Facebook" className="hover:text-fb">
                      <span className="bi bi-facebook"></span>
                    </a>
                    <a href="#" target="_blank" title="Síguenos en Twitter" className="hover:text-x">
                      <span className="bi bi-twitter"></span>
                    </a>
                    <a href="#" target="_blank" title="Síguenos en Linkedin" className="hover:text-li">
