...
function Applicants() {
  return (
    <>
      {/* ========== Start ASPIRANTES ========== */}
      <div className="p-12 overflow-auto" style={{ gridArea: 'content' }}>
        <section>
          <h2 className="text-3xl text-stone-950">Aspirantes</h2>
          <article className="p-0 grid grid-cols-3 gap-8">
            <div className="bg-slate-50 h-80 text-center p-3 border border-stone-50 rounded-md shadow-xl mb-5">
              ...
              <div className="mt-5 pt-5 w-full border-t border-stone-400 flex items-center justify-between">
                <button>
