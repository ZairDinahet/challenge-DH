            ...
            <form action="#" method="POST">
              <div className="grid grid-cols-1 sm:grid-cols-2">
                <div className="mb-4">
                  ...
                  <input type="text" id="name" name="name" placeholder="Nombre" className="p-3 mt-2 mb-2 h-8 w-3/4 bg-stone-100 rounded-md border border-stone-500"/>
                </div>
                <div className="mb-4">
                  <label for="lastname" className="block text-sm font-medium text-stone-500">Apellido</label>
                  <input type="text" id="lastname" name="lastname" placeholder="Apellido" className="p-3 mt-2 mb-2 h-8 w-3/4 bg-stone-100 rounded-md border border-stone-500"/>
                </div>
                <div className="mb-4">
                  <label for="email" className="block text-sm font-medium text-stone-500">Correo electrónico</label>
                  <input type="email" id="email" name="email" placeholder="Correo electrónico" className="p-3 mt-2 mb-2 h-8 w-3/4 bg-stone-100 rounded-md border border-stone-500"/>
                </div>
                <div className="mb-4">
                  <label for="phone" className="block text-sm font-medium text-stone-500">Teléfono</label>
                  <input type="text" id="phone" name="phone" placeholder="Telefono" className="p-3 mt-2 mb-2 h-8 w-3/4 bg-stone-100 rounded-md border border-stone-500"/>
                </div>
                <div className="mb-4">
                  <label for="linkedin" className="block text-sm font-medium text-stone-500">Linkedin</label>
                  <input type="text" id="linkedin" name="linkedin" placeholder="Linkedin" className="p-3 mt-2 mb-2 h-8 w-3/4 bg-stone-100 rounded-md border border-stone-500"/>
                </div>
                <div className="mb-4">
                  <label htmlFor="birthday" className="block text-sm font-medium text-stone-500">Fecha de Cumpleaños</label>
                  <input type="date" id="birthday" name="birthday" className="p-3 mt-2 mb-2 h-8 w-3/4 bg-stone-100 rounded-md border border-stone-500"/>
                </div>
                <div className="mb-4">
                  <label for="city" className="block text-sm font-medium text-stone-500">Ciudad</label>
                  <input type="text" id="city" name="city" placeholder="Ciudad" className="p-3 mt-2 mb-2 h-8 w-3/4 bg-stone-100 rounded-md border border-stone-500"/>
                </div>
                <div className="mb-4">
                  <label for="country" className="block text-sm font-medium text-stone-500">Pais</label>
                  <input type="text" id="country" name="country" placeholder="Pais" className="p-3 mt-2 mb-2 h-8 w-3/4 bg-stone-100 rounded-md border border-stone-500"/>
                </div>
                <div className="mb-4">
                  <label for="aboutme" className="block text-sm font-medium text-stone-500">Sobre mi</label>
                  <textarea name="message" rows="6" placeholder="Sobre mi" className="p-3 bg-stone-100 mt-3 mb-3 w-3/4 rounded-md border border-stone-500"></textarea>
                </div>
                <div className="mb-4">
                  <label for="img" className="block text-sm font-medium text-stone-500">Adjuntar Imagen</label>
                  <input type="file" id="img" name="img" className="p-3 mt-2 mb-2 h-8 w-3/4"/>
                </div>
              </div>
